...
def create_video_from_states(input_filename, output_filename, states_txt):

    recorded_states = torch.load(input_filename)
    video_frames = []
...
if __name__ == "__main__":
    ...
    create_video_from_states(states_pth, states_video_path, states_loaded_txt)
    compare_state_files(recorded_video_path, actions_video_path, states_video_path, combined_video_path)

    compare_state_files(recorded_states_txt, states_from_actions_txt)
    compare_state_files(recorded_states_txt, states_loaded_txt)
